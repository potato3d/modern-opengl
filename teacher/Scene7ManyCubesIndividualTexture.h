...
public:
	bool initialize()
	{
		...
		ShaderLoader loader;
		if(!loader.addFile(GL_VERTEX_SHADER, "../src/Scene7ManyCubesIndividualTexture.vert", "../src/ShaderData.h"))
		{
			return false;
		}
		if(!loader.addFile(GL_FRAGMENT_SHADER, "../src/Scene7ManyCubesIndividualTexture.frag", "../src/ShaderData.h"))
		{
			return false;
		}
	...
	void draw(const CameraData& cameraData)
	{
		...
		{
			glBindTextureUnit(TEX_TEXTURE, _textures.at(i));
