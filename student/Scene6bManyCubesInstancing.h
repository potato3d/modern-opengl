...
public:
	bool initialize()
	{
		...
		//scene6b: create buffer and store transforms

		//scene6b: increment buffer index inside vao

		//scene6b: add transform buffer to vao

		//scene6b: enable instancing for entire transform buffer

		//scene6b: setup transform attrib
