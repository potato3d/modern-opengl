...
public:
	bool initialize()
	{
		...
		//scene12: create buffer

		//scene12: setup correct flags
		...
		//scene12: allocate storage using flags
		...
		//scene12: map GPU buffer to CPU pointer until end of program execution (aka persistent mapping)

		//scene12: check mapped pointer
	...
	void draw(const CameraData& cameraData)
	{
		...
		//scene12: begin frame in frustum culler

		//scene12: collect visible drawables
		...
		//scene12: copy to persistent-mapped buffer

		// 3- flush newly written contents from the CPU to the GPU
		//scene12: flush buffer range
		...
		// draw
		//scene12: draw using visible drawable count
