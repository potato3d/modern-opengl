...
public:
	bool initialize()
	{
		...
		ShaderLoader loader;
		if(!loader.addFile(GL_VERTEX_SHADER, "../src/Scene6ManyCubesInstancing.vert", "../src/ShaderData.h"))
		{
			return false;
		}
		if(!loader.addFile(GL_FRAGMENT_SHADER, "../src/Scene6ManyCubesInstancing.frag", "../src/ShaderData.h"))
		{
			return false;
		}
		...
		//scene6: create ssbo for all transforms

		//scene6: create ssbo for all materials
